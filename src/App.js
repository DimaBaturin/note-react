...
function App() {
    ...
    const [hideAddPopUp, sethidePopUp] = React.useState(false)
    const [hideInformation, sethideInformation] = React.useState(false)
    const [hideEditPopUp, setEditPopUp] = React.useState(false)
    ...
    React.useEffect(() => {
        ...
        }, [hideAddPopUp, delNote, hideEditPopUp] // bred
    )
    async function CreateNote(title, text){
        if(text && title) {
           ...
           const result = await axios.post('http://localhost:3001/notes', {
            ...
            console.log('введи text')
        }else if(!title){
            console.log('введи title')
        }
    }
    ...
    <>
      <div className="menu">
        ...
        <div className='add_menu'>
            <svg onClick={() => ClickOnAdd()} width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="43" height="43" rx="21.5" fill="black"/>
                <path d="M14 21H28M21 14V28" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>
          </div>
      </div>
      ...
      <div className="main">
        <div className="search">
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15 15L10.3333 10.3333M11.8889 6.44444C11.8889 7.52125 11.5696 8.57388 10.9713 9.46922C10.3731 10.3645 9.52279 11.0624 8.52794 11.4745C7.5331 11.8865 6.43841 11.9944 5.38229 11.7843C4.32617 11.5742 3.35606 11.0557 2.59464 10.2942C1.83322 9.53283 1.31469 8.56272 1.10462 7.5066C0.894541 6.45048 1.00236 5.35579 1.41444 4.36095C1.82651 3.3661 2.52434 2.5158 3.41967 1.91755C4.31501 1.31931 5.36764 1 6.44445 1C7.8884 1 9.27322 1.57361 10.2942 2.59464C11.3153 3.61567 11.8889 5.00049 11.8889 6.44444Z" stroke="black" strokeOpacity="0.7" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>
